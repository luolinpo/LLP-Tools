...
namespace FileAssistant
{
    public class BitmapRegion
    {
        ...
        public static void CreateControlRegion(Control control, Bitmap bitmap,int width,int heiht)
        {
        ...
        public static GraphicsPath CalculateControlGraphicsPath2(Bitmap bitmap)
        {
